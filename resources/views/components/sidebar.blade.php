<x-app-layout>
   <!-- component -->
<div class="w-screen h-screen bg-gray-100 flex justify-left items-left">
    <div class="  ml- flex w-16 flex-col items-left space-y-6 py-0 left-0">
      ...
      <div class="space-y-48 rounded-md bg-white h-screen">
        <ul>
          <li class="p-5">
