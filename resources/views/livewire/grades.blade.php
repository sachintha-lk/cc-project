        ...
        <div class="bg-blue-300  shadow rounded-lg grade-card h-24">
            ...
            <div class="links-container">
                ...
                <a href="{{ route('class', ['gradeId' => $grade->id]) }}">
                    <div class="w-4 mr-2 transform hover:text-blue-100 hover:scale-110">
                ...
                <button class="w-4 mr-2 transform hover:text-blue-100 hover:scale-110"  wire:click="confirmGradeUpdate({{ $grade->id }})" wire:loading.attr="disabled">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                </button>
                {{-- delete --}}
                <button class="w-4 mr-2 transform hover:text-blue-100 hover:scale-110" wire:click="confirmGradeDeletion({{ $grade->id }})" wire:loading.attr="disabled">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
