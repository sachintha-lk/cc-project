    ...
    <div class="md:w-1/2">
        ...
        <div class="m-3">
            ...
            <input w wire:model="q" type="search" placeholder="Search" name="student_search"
                   class="block w-1/3 py-2.5 rounded focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-400"
                   required>
        </div>
        <div class="m-3">
                            ...
                            <td class="border-t-0 px-1 align-middle text-xs font-medium text-gray-900 whitespace-nowrap py-1 flex">
                                ...
                                <div class="ml-2">
                                    <button wire:click="selectStudent({{$student->id}})" wire:loading.attr="disabled"
                                            class="bg-blue-800 border border-transparent hover:bg-blue-600 focus:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                        Select
                                    </button>
    ...
    <div class="md:w-1/3">
        ...
        <div class="flex gap-2 my-4">
            <button wire:click="addSelectedStudentsToClass" wire:loading.attr="disabled"
                    class="bg-blue-800 border border-transparent  hover:bg-blue-500 focus:bg-blue-700 text-white font-bold py-2 px-4 rounded">
