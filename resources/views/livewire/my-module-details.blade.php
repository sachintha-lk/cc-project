        ...
        <div class="flex items-center mt-4">
            ...
            @if ($assignment->submissions->count() > 0)
                @if ($assignment->submissions->first()->submissionGrade)
                    <span class="text-sm font-semibold text-green-600 ml-2">Graded</span>
...
<div class="bg-blue-100 rounded px-4 py-5 mt-5">
    <h1 class=" font-semibold rounded h-8 w text-lg  text-gray-800 mb-2 ">Quiz Leaderboard</h1>
...
<div class="bg-blue-100 rounded px-4 py-1 mt-5">
    <h1 class="mt-2 font-semibold h-8 w text-lg  text-gray-800 mb-2 ">Quizzes</h1>
    @if(isset($quizzes))
    @foreach ($quizzes as $quiz)
        <div class="flex items-center mt-4">
            <a href="{{route('student-quiz-view', [$module->id, $quiz->slug])}}" class="text-blue-950 flex space- ">
...
<div class="bg-blue-100 rounded px-4 py-1 mt-5">
    <h1 class="mt-2 font-semibold rounded h-8 w text-lg  text-gray-800 mb-2 ">Course Resources</h1>
...
{{--        </div>--}}
        ...
        @if($resource->type == 'link')
            ...
            <div class="flex items-center mt-4">
                <a href="{{ $resource->resource }}" target="_blank" class="text-blue-950 flex space- ">
        ...
        @elseif($resource->type == 'text')
            ...
            <div class="items-center mt-4">
                    <h3 class="text-lg font-semibold underline-offset-2 ml-2 text-blue-600">{{ $resource->name }}</h3>
