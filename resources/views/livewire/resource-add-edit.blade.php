<div class="w-9/12 mx-auto">
        <div class="m-2">
            ...
            <input id="name" type="text" wire:model="name" class=" block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500
                      focus:border-blue-500 sm:text-sm" placeholder="Resource Name">
            <x-input-error for="name" class="mt-2"/>
        </div>
        <div class="m-2">
            <label for="type" class="block text-sm font-medium text-gray-700">Resource Type</label>
            <select id="type" wire:model="type" class=" block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500
        ...
        <div class="m-2">
            ...
            <input id="resource_link" type="text" wire:model="resource_link" class=" block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500
                      focus:border-blue-500 sm:text-sm" placeholder="Resource Link">
        ...
        <div class="m-2">
            ...
            <input id="resource_file" type="file" wire:model="resource_file" class=" block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500
                      focus:border-blue-500 sm:text-sm" placeholder="Resource File">
        ...
        <div class="m-2">
            ...
            <textarea id="resource_text" wire:model="resource_text" class=" block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500
                      focus:border-blue-500 sm:text-sm" placeholder="Resource Text"></textarea>
