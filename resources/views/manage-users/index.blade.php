                            ...
                            @foreach ($students as $student)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        @if ($student->status == 1)
                                            <span
                                                class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs font-semibold">Active</span>

                                        @elseif ($student->status == 0)
                                            <span
                                                class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs font-semibold">Inactive</span>
                                        @endif
                                    </td>
                                    <td class="py-3 px-6 text-center">
